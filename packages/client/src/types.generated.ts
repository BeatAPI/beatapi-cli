...
export interface components {
    schemas: {
        ...
        MinimaxH3MaxVideoRequest: {
            ...
            images?: string[];
            /**
             * @description Requested output duration in seconds. fal requires at least 5 seconds; shorter values are rejected before submission. Billed per second at the rate for the chosen resolution.
             * @default 5
             */
            duration: number;
            /**
        ...
        CapabilityContract: {
            ...
            /** @description First-party usage guidance. Detailed Run examples appear here for selected data capabilities and are omitted from Search responses. */
            documentation?: {
                /** Format: uri */
                url: string;
                run_example?: {
